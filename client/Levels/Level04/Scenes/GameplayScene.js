export class Level04_GameplayScene extends Phaser.Scene {
    constructor() {
    ...
    startWaveSpawning() {
        ...
        // Spawn a collectible star during this wave
        ...
        // End wave spawning after duration
    ...
    endWaveSpawning() {
        ...
        // Wait for remaining debris to pass, then show fact
    ...
    handleGameOver() {
        ...
        this.time.delayedCall(1000, () => {
            ...
            const backText = this.add.text(960, 720, '[ Press ESC to quit ]', {
                fontSize: '22px',
                fontFamily: 'Arial',
                color: '#888888'
            }).setOrigin(0.5).setDepth(301);
    ...
    completeLevel() {
        ...
        this.tweens.add({
            ...
            onComplete: () => {
                victoryText.destroy();
                this.scene.start('Level04_CompletionScene', {
                    score: this.score,
                    starsCollected: this.starsCollected,
                    debrisDestroyed: this.debrisDestroyed
                });
            }
        });
    }
    ...
    update(time, delta) {
        ...
        // Clean up debris that passed the screen (damages Earth)
